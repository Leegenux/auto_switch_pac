var FindProxyForURL = function(init, profiles) {
    ...
    "+auto switch": function(url, host, scheme) {
        "use strict";
        if (/(?:^|\.)spotofdata\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)nutgeek\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)nixos\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)distrowatch\.com$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)plugmedia\.hk$/.test(host)) return "+proxy";
        if (/(?:^|\.)pcmarket\.com\.hk$/.test(host)) return "+proxy";
        if (/(?:^|\.)raw\.githubusercontent\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)github\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)gentoo\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)wordreference\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)jquery\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)googletagservices\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)purechat\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)google-analytics\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)onenote\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)live\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)twitter\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)kite\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)airbrake\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)pentester\.land$/.test(host)) return "+proxy";
        if (/(?:^|\.)launchpad\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)launchpadlibrarian\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)smartmontools\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)zendesk\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)recaptcha\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)geny\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)stripe\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)genymotion\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)python\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)readthedocs\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)readthedocs\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)aldolipani\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)embpcb\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)towardsdatascience\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)googleusercontent\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)gstatic\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)medium\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)nips\.cc$/.test(host)) return "+proxy";
        if (/(?:^|\.)apachecn\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)coolshell\.cn$/.test(host)) return "+proxy";
        if (/(?:^|\.)utteranc\.es$/.test(host)) return "+proxy";
        if (/(?:^|\.)licensebuttons\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)googletagmanager\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)mellanox\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)anu\.edu\.au$/.test(host)) return "+proxy";
        if (/(?:^|\.)csp\.withgoogle\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)apmemory\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)archlinux\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)ohmyarch\.github\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)1001freefonts\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)winaero\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)tecmint\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)adobedtm\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)mathworks\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)fontawesome\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)microchip\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)microchipdirect\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)osuosl\.org$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)realpython\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)redis\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)linuxtopia\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)lwn\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)linuxquestions\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)cateee\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)overleaf\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)sharelatex-wiki-cdn-671420\.c\.cdn77\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)wikipedia\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)wikimedia\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)cloudflare\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)chainer\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)arxiv\.org$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)wcheinz\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)futurestud\.io$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)arm\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)jedec\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)liveperson\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)componentsearchengine\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)lpsnmedia\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)scorecardresearch\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)timestamp\.online$/.test(host)) return "+proxy";
        if (/(?:^|\.)djangoproject\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)lwks\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)st\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)khronos\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)ibruce\.info$/.test(host)) return "+proxy";
        if (/(?:^|\.)hegongshan\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)kernel\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)nvidia\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)twitcount\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)netdna-ssl\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)d2jmvrsizmvf4x\.cloudfront\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)d3ow3r1jtq29si\.cloudfront\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)socratic\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)machinelearningmastery\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)play0ad\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)mozilla\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)tongliang-liu\.github\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)pyimagesearch\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)jsqpro\.xyz$/.test(host)) return "+proxy";
        if (/(?:^|\.)comap\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)fedoraforum\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)debian\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)brown\.edu$/.test(host)) return "+proxy";
        if (/(?:^|\.)tamu\.edu$/.test(host)) return "+proxy";
        if (/(?:^|\.)northwestern\.edu$/.test(host)) return "+proxy";
        if (/(?:^|\.)fonts\.googleapis\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)scipy\.org$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)render\.githubusercontent\.com$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)ebay\.ie$/.test(host)) return "+proxy";
        if (/(?:^|\.)alldatasheet\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)hkinventory\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)raspi\.tv$/.test(host)) return "+proxy";
        if (/(?:^|\.)getpocket\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)linuxreviews\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)findchips\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)superuser\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)issi\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)ou\.edu$/.test(host)) return "+proxy";
        if (/(?:^|\.)uber\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)toronto\.edu$/.test(host)) return "+proxy";
        if (/(?:^|\.)davheld\.github\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)umd\.edu$/.test(host)) return "+proxy";
        if (/(?:^|\.)columbia\.edu$/.test(host)) return "+proxy";
        if (/(?:^|\.)buffalo\.edu$/.test(host)) return "+proxy";
        if (/(?:^|\.)stackoverflow\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)tianyin\.github\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)intel\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)csrankings\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)ethz\.ch$/.test(host)) return "+proxy";
        if (/(?:^|\.)micron\.com$/.test(host)) return "+proxy";
